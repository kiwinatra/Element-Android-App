...
public final class MediaMetadataCompat implements Parcelable {
    ...
    static final C0255a f325b;

    /* renamed from: c  reason: collision with root package name */
    private static final String[] f326c = {"android.media.metadata.TITLE", "android.media.metadata.ARTIST", "android.media.metadata.ALBUM", "android.media.metadata.ALBUM_ARTIST", "android.media.metadata.WRITER", "android.media.metadata.AUTHOR", "android.media.metadata.COMPOSER"};

    /* renamed from: d  reason: collision with root package name */
    private static final String[] f327d = {"android.media.metadata.DISPLAY_ICON", "android.media.metadata.ART", "android.media.metadata.ALBUM_ART"};

    /* renamed from: e  reason: collision with root package name */
    private static final String[] f328e = {"android.media.metadata.DISPLAY_ICON_URI", "android.media.metadata.ART_URI", "android.media.metadata.ALBUM_ART_URI"};
    ...
    MediaMetadataCompat(Parcel parcel) {
        this.f329a = parcel.readBundle(MediaSessionCompat.class.getClassLoader());
    }
